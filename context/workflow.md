...
**Purpose:** Pre-fill CONTEXT.md by extracting and confirming codebase knowledge section by section (Purpose, Stack, Run, Test, Architecture, Structure, Integrations, Workflow, Gotchas).
